...
<aside>The label placement in gghighlight uses Kamil Slowikowski's [__ggrepel__](https://github.com/slowkow/ggrepel) package, which repels overlapping text labels away from each other.</aside>
